const { getStatisticalUser, getStatisticalRegister, getStatisticalTurn, getStatisticalSumTurn, getStatisticalSumRegister } = require('~/controllers/statisticalController')
